...
## 3. Execução ⏯️
- Execute o arquivo `EntradaBILP.py` e depois dando uma entrada válida ou redirecionando de um arquivo de entrada (`python3 EntradaBILP.py < session-1.txt`), que gerará um novo `BILP.dat`
